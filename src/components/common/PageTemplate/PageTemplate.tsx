...
const PageTemplate = (props: PageTemplateProps) => {
  return (
    <>
       ...
       */}
      <div className="bg-background-main relative mx-auto min-h-screen w-full max-w-full px-[15px] before:fixed before:top-0 before:left-0 before:h-screen before:w-screen before:animate-bg-zoom before:bg-[url('/site_bg.svg')] before:bg-cover before:bg-center before:bg-no-repeat before:opacity-60 before:grayscale before:content-[''] md:px-[50px]">
        <ParticleBackdrop />
        <HeaderNavigation />
        <SnsList />
